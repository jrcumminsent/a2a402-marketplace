...
await check('/',b=>typeof b==='string'&&/Your agent doesn't have to do everything/i.test(b)&&/Route a need|POST \/need/i.test(b)&&/USDC/i.test(b)&&b.includes('rel="canonical" href="https://a2a402.market/"')&&b.includes('property="og:title"')&&b.includes('name="twitter:card"'));
...
console.log('Public smoke passed: real-external-only public truth, validation funnel, reputation and modern lifecycle guards');
