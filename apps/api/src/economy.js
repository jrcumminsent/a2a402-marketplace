...
export class Economy {
  constructor({ paymentProvider = new MockTestProvider(), loungeEnabled = true } = {}) {
    this.paymentProvider = paymentProvider; this.loungeEnabled = loungeEnabled;
    this.agents = new Map(); this.jobs = new Map(); this.transactions = []; this.reputations = new Map(); this.services = new Map(); this.lounge = []; this.events = [];
  }
