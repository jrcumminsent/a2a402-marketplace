...
export function errorResponse(error){
  ...
  else if(lower.includes('required')||lower.includes('must ')||lower.includes('invalid')||lower.includes('unsupported')||lower.includes('supports at most')||lower.includes('positive')||lower.includes('payload too large')){status=422;code='VALIDATION_FAILED'}
